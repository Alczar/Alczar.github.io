...
function nandGateKeeper(event) {
    ...
    //Door5
    nandGate(bool5_1, bool5_2, door5);
...
function xnorGateKeeper(event) {
    ...
    //Door8
    xnorGate(bool8_1, bool8_2, door8);
